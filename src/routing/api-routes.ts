...
const ApiRoutes = {
  ...
  publicEventInfo: (id: number) => "/api/event/" + id + "/public",
  privateEventInfo: (id: number) => "/api/event/" + id + "/private",
  publicGrantInfo: (id: number) => "/api/grant/" + id + "/public",
  publicSupervisionInfo: (id: number) => "/api/supervision/" + id + "/public",
  privateSupervisionInfo: (id: number) => "/api/supervision/" + id + "/private",
  privateMemberInfo: (id: number) => "/api/member/" + id + "/private",
  privateProductInfo: (id: number) => "/api/product/" + id + "/private",
  privateGrantInfo: (id: number) => "/api/grant/" + id + "/private",
  ...
  deleteGrant: (id: number) => "/api/delete-grant/" + id,
  ...
  registerGrant: "/api/register-grant",
