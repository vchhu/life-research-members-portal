...
import GrantMemberInvestigatorTag from "./grant-member-invloved-tag";
...
const GrantMemberInvestigatorSelector: FC<Props> = ({
  id = "",
  ...
  return (
    <>
      <div className="grant-member-investigator-selector">
...
export default GrantMemberInvestigatorSelector;
