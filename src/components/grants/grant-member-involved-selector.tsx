...
import GrantMemberInvolvedTag from "./grant-member-invloved-tag";
...
const GrantMemberInvolvedSelector: FC<Props> = ({
  id = "",
  ...
  return (
    <>
      <div className="grant-member-involved-selector">
...
export default GrantMemberInvolvedSelector;
