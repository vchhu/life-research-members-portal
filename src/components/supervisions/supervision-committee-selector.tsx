...
import SupervisionCommitteeTag from "./supervision-committee-tag";
...
const SupervisionCommitteeSelector: FC<Props> = ({
  id = "",
...
export default SupervisionCommitteeSelector;
