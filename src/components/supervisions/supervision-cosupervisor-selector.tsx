...
import SupervisionCoSupervisorTag from "./supervision-cosupervisor-tag";
...
const SupervisionCoSupervisorSelector: FC<Props> = ({
  id = "",
  ...
  return (
    <>
      <div className="supervision-cosupervisor-selector">
...
export default SupervisionCoSupervisorSelector;
