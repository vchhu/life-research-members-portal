import type { RegisterEventParams, RegisterEventRes } from "../pages/api/register-event";
...
export default async function registerEvent(
    ...
    try {
        notification.loading(en ? "Registering an event..." : "Enregistrement d'un événement...");
